...
const tabs = [
  ...
  },
  {
    ...
    icon: (
      <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        <path d="M22 16.92v3a2 2 0 0 1-2.18 2 19.79 19.79 0 0 1-8.63-3.07A19.5 19.5 0 0 1 4.69 12a19.79 19.79 0 0 1-3.07-8.67A2 2 0 0 1 3.6 1.18h3a2 2 0 0 1 2 1.72c.127.96.361 1.903.7 2.81a2 2 0 0 1-.45 2.11L7.91 8.09a16 16 0 0 0 6 6l.91-.91a2 2 0 0 1 2.11-.45c.907.339 1.85.573 2.81.7a2 2 0 0 1 1.72 2.02z"/>
      </svg>
    )
  },
  {
          ...
          <div style={{ padding: '28px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px' }}>
              <div style={{ gridColumn: '1 / -1' }}>
                <label style={labelStyle}>Nama Theater</label>
                <input
                  type="text"
                  value={settings['theater_name'] ?? ''}
                  onChange={(e) => updateSetting('theater_name', e.target.value)}
                  style={inputStyle}
                  onFocus={(e) => e.target.style.borderColor = '#8B0000'}
                  onBlur={(e) => e.target.style.borderColor = '#e5e7eb'}
                />
              ...
              <div>
                ...
                <input
                  type="time"
                  value={settings['operating_hours_start'] ?? '07:00'}
              ...
              <div>
                ...
                <input
                  type="time"
                  value={settings['operating_hours_end'] ?? '22:30'}
              ...
              <div>
                ...
                <input
                  ...
                  min="1"
                  max="30"
                  value={settings['min_advance_days'] ?? '5'}
                  onChange={(e) => updateSetting('min_advance_days', e.target.value)}
                  style={inputStyle}
                  onFocus={(e) => e.target.style.borderColor = '#8B0000'}
                  onBlur={(e) => e.target.style.borderColor = '#e5e7eb'}
                />
              ...
              <div>
                ...
                <input
                  ...
                  min="1"
                  max="16"
                  value={settings['max_booking_hours'] ?? '8'}
                  onChange={(e) => updateSetting('max_booking_hours', e.target.value)}
                  style={inputStyle}
                  onFocus={(e) => e.target.style.borderColor = '#8B0000'}
                  onBlur={(e) => e.target.style.borderColor = '#e5e7eb'}
                />
            ...
            <div style={{ marginTop: '16px' }}>
              ...
              <textarea
                ...
                onChange={(e) => updateSetting('warning_message', e.target.value)}
                rows={3}
                style={{ ...inputStyle, resize: 'vertical' }}
                onFocus={(e) => e.target.style.borderColor = '#8B0000'}
                onBlur={(e) => e.target.style.borderColor = '#e5e7eb'}
          ...
          <div style={{ padding: '28px' }}>
            ...
            <div>
              ...
              <p style={{ fontSize: '11px', color: '#9ca3af', marginTop: '4px' }}>
                Email ini akan menerima notifikasi tempahan baru
              </p>
            </div>
          </div>
        )}
